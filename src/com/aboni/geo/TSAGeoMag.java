...
public class TSAGeoMag {
     ...
     * Instantiates object by calling initModel().
     */
    public TSAGeoMag(String wmmModel, Logger lg) {
        if (lg == null) {
     ...
     * file properly.
     */
    private void initModel(String wmmFile) {
        glat = 0;
        glon = 0;
    ...
    private void readWMM(String file) {
        try (InputStream isInput = new FileInputStream(new File(file))) {
